...
WebUI.setText(findTestObject('password field'), 'dummmdumm')

WebUI.verifyElementHasAttribute(findTestObject('captcha field'), 'required', 0)

'Manual Input Invalid Captcha'
WebUI.delay(10)
...
WebUI.verifyElementText(findTestObject('Warning captcha'), 'Captcha not match!')

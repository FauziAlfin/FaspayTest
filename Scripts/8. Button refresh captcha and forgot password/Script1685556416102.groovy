...
WebUI.click(findTestObject('refresh captcha button'))

WebUI.verifyElementClickable(findTestObject('refresh captcha button'))

WebUI.verifyElementClickable(findTestObject('forget password button'))
